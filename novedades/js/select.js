...
$(document).ready(function () {
    ...
    $('#Filtros').on('shown.bs.modal', function () {
        ...
        $(".selectjs_empresa").select2({
            ...
            ajax: {
                url: "/" + $("#_homehost").val() + "/novedades/getSelect/getEmpFichas.php",
                dataType: "json",
                type: "POST",
                delay: opt2["delay"],
        ...
        $(".selectjs_plantas").select2({
            ...
            ajax: {
                url: "/" + $("#_homehost").val() + "/novedades/getSelect/getPlanFichas.php",
                dataType: "json",
                type: "POST",
                delay: opt2["delay"],
                data: function (params) {
        ...
        $(".selectjs_sectores").select2({
            ...
            ajax: {
                url: "/" + $("#_homehost").val() + "/novedades/getSelect/getSectFichas.php",
                dataType: "json",
                type: "POST",
                delay: opt2["delay"],
                data: function (params) {
        ...
        $(".select_seccion").select2({
            ...
            ajax: {
                url: "/" + $("#_homehost").val() + "/novedades/getSelect/getSec2Fichas.php",
                dataType: "json",
                type: "POST",
                delay: opt2["delay"],
                data: function (params) {
        ...
        $(".selectjs_grupos").select2({
            ...
            ajax: {
                url: "/" + $("#_homehost").val() + "/novedades/getSelect/getGrupFichas.php",
                dataType: "json",
                type: "POST",
                delay: opt2["delay"],
                data: function (params) {
        ...
        $(".selectjs_sucursal").select2({
            ...
            ajax: {
                url: "/" + $("#_homehost").val() + "/novedades/getSelect/getSucFichas.php",
                dataType: "json",
                type: "POST",
                delay: opt2["delay"],
                data: function (params) {
        ...
        $(".selectjs_personal").select2({
            ...
            ajax: {
                url: "/" + $("#_homehost").val() + "/novedades/getSelect/getLegajosFichas.php",
                dataType: "json",
                type: "POST",
                delay: opt2["delay"],
                data: function (params) {
        ...
        $(".selectjs_tipoper").select2({
            ...
            ajax: {
                url: "/" + $("#_homehost").val() + "/novedades/getSelect/getTipoPerFichas.php",
                dataType: "json",
                type: "POST",
                delay: opt2["delay"],
                data: function (params) {
        ...
        $(".selectjs_FicNoTi").select2({
            ...
            ajax: {
                url: "/" + $("#_homehost").val() + "/novedades/getSelect/getTipoNovedad.php",
                dataType: "json",
                type: "POST",
                delay: opt2["delay"],
                data: function (params) {
        ...
        $(".selectjs_FicNove").select2({
            ...
            ajax: {
                url: "/" + $("#_homehost").val() + "/novedades/getSelect/getFicNove.php",
                dataType: "json",
                type: "POST",
                delay: opt2["delay"],
                data: function (params) {
