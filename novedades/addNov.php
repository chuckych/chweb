            ...
            <div class="row">
                ...
                <div class="col-12">
                    <div class="d-inline-flex mt-1 w-100">
                        <!-- Rango de Fecha -->
                        <div style="width:100%;">
                            <input type="text" readonly class="bg-white h40 fw5 form-control text-center ls1"
                                name="_draddNov" id="_draddNov">
                        </div>
                    </div>
                    <div class="d-inline-flex mt-1 w-100">
                        <!-- Novedad -->
                        ...
                        <div class="ml-1" style="width:30%;">
                            <input type="text" placeholder="00:00" name="aFicHoras" id="aFicHoras"
                                class="HoraMask ls1 form-control text-center FicHoras h40" autocomplete="off">
                        </div>
                    </div>
                    ...
                    <div class="d-inline-flex mt-1 w-100">
                        <!-- Observacion -->
                        <div style="width:100%;">
                            <input type="text" placeholder="Observación" class="form-control h40" name="aFicObse"
                                id="aFicObse" maxlength="40">
                        </div>
                    </div>
                    <div class="mt-3 d-flex justify-content-between">
                        <div class="custom-control custom-checkbox">
                            <input type="checkbox" class="custom-control-input" name="aFicCate" id="aFicCate">
                            <label class="custom-control-label" for="aFicCate" style="padding-top:3px;">Novedad
                                Forzada</label>
                        </div>
                        <div class="custom-control custom-checkbox">
                            <input type="checkbox" class="custom-control-input" name="aLaboral" id="aLaboral">
                            <label class="custom-control-label" for="aLaboral" style="padding-top:3px;">Cargar solo
                                d&iacute;as laborales</label>
                        </div>
                        <div class="custom-control custom-checkbox invisible">
                            ...
                            <label class="custom-control-label" for="aFicJust"
                ...
                <div class="col-12 mt-3 d-flex justify-content-start">
                    <span class="fontq text-dark">Nota: <br>Para la carga por Filtros. al menos un filtro es
                        obligatorio. Para la carga por Legajos, al menos un legajo es obligatorio.</span>
                </div>
