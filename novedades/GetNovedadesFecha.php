...
$sql_query="SELECT DISTINCT FICHAS3.FicLega AS nov_LegNume, PERSONAL.LegApNo AS nov_leg_nombre, FICHAS3.FicFech AS 'nov_Fecha', dbo.fn_DiaDeLaSemana(FICHAS3.FicFech) AS 'nov_dia_semana', dbo.fn_HorarioAsignado( FICHAS.FicHorE, FICHAS.FicHorS, FICHAS.FicDiaL, FICHAS.FicDiaF ) AS 'nov_horario' FROM FICHAS3, FICHAS, NOVEDAD, NOVECAUSA, PERSONAL WHERE FICHAS3.FicFech='$Fecha' AND FICHAS3.FicLega=FICHAS.FicLega AND FICHAS3.FicFech=FICHAS.FicFech AND FICHAS3.FicTurn=FICHAS.FicTurn AND FICHAS3.FicNove=NOVEDAD.NovCodi AND FICHAS3.FicNove=NOVECAUSA.NovCNove AND FICHAS3.FicCaus=NOVECAUSA.NovCCodi AND FICHAS3.FicLega=PERSONAL.LegNume AND FICHAS3.FicNove >0 AND FICHAS3.FicNoTi >=0 $FilterEstruct $FilterEstruct2 $FiltrosFichas";
...
$sqlRec .=  " ORDER BY FICHAS3.FicLega,FICHAS3.FICFech, PERSONAL.LegApNo OFFSET ".$params['start']." ROWS FETCH NEXT ".$params['length']." ROWS ONLY";
...
$query_Nov="SELECT FICHAS3.FicNove AS nov_novedad, NOVEDAD.NovDesc AS nov_descripcion, NOVEDAD.NovTipo AS nov_tipo, FICHAS3.FicHoras AS nov_horas, FICHAS3.FicCaus AS nov_cod_causa, NOVECAUSA.NovCDesc AS nov_causa, nov_justif=CASE FICHAS3.FicJust WHEN 1 THEN 'Si' ELSE 'No' END, FICHAS3.FicObse AS nov_observ FROM FICHAS3, NOVEDAD, NOVECAUSA WHERE FICHAS3.FicFech='$nov_Fecha2' AND FICHAS3.FicLega='$nov_LegNume' AND FICHAS3.FicNove=NOVEDAD.NovCodi AND FICHAS3.FicNove=NOVECAUSA.NovCNove AND FICHAS3.FicCaus=NOVECAUSA.NovCCodi $FilterEstruct2";
