            ...
            <div class="row">
                <div class="mx-auto col-12 col-md-6 col-sm-8 col-lg-5 col-xl-4 p-0 border-0">
                    <div class="mx-auto shadow ancho">
                        <div class="p-4 bg-custom text-white fw4"
                            style="border-top-left-radius: 0.3em 0.3em; border-top-right-radius: 0.3em 0.3em;">
                            <p class="text-left lead mb-0">INGRESO | CH-WEB </p><span class="text-left fontq">Iniciar
                                sesi&oacute;n para continuar.</span>
                        </div>
                        <div class="p-4 bg-white">
                            <div class="form-group">
                                <label for="user" class="fw4">Usuario</label>
                                <input required type="text" class="form-control text-lowercase mr-1 mb-2 h50" id="user"
                                    placeholder="" name="user" value="<?= $usuario ?>">
                                <div class="input-group">
                                    <div class="input-group-prepend" style="width:100% !important">
                                        <input required type="password" class="form-control h50" id="clave"
                                            placeholder="" name="clave" value="<?= $clave; ?>">
                            ...
                            <div class="form-row px-3 mt-4">
                                <div class="custom-control custom-switch">
                                    <input <?= $checked ?> type="checkbox" class="custom-control-input" name="guarda"
                                        id="guarda">
                                    <label class="custom-control-label fw4" for="guarda"
                                        style="padding-top:3px;">Recordarme</label>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-12" id="btnIngresar">
                                <button type="submit" class="btn-block btn btn-lg opa7 h60 bg-custom text-white font1"
                                    style="border-bottom-left-radius: 0.3em 0.3em; border-bottom-right-radius: 0.3em 0.3em;border-top-left-radius: 0.0em 0.0em;border-top-right-radius: 0.0em 0.0em;">
                                    <span>INGRESAR</span>
                                </button>
                            </div>
                        </div>
