...
while ($row = sqlsrv_fetch_array($queryRecords)) :
    ...
    $data[] = array(
        'Legajo'      => $row['Legajo'],
        'Nombre'      => $row['Nombre'],
        'LegNombre'   => $row['Nombre'].'<br><span class="fw3">Legajo: </span>'.$row['Legajo'],
