...
$totalRecords = sqlsrv_num_rows($queryRecords);
    ...
    if ($totalRecords > 0) {
        while ($row = sqlsrv_fetch_array($queryRecords)) :
            $HorasAuto = MinHora2($row['HsAutorizadas']);
