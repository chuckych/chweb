<?php
$opt2 = array(
    'MinLength' => 0, 'SelClose' => false, 'MaxInpLength' => 10, 'delay' => 250
);
?>
<!-- select2.min.js -->
...
<script>
    ...
    $(document).ready(function() {
        var opt2 = {MinLength:"0", SelClose:"0", MaxInpLength:"10", delay:"250"};
        ...
        $(".selectjs_personal2").select2({
            ...
            ajax: {
                url: "<?=host()?>/<?=HOMEHOST?>/filtros/array_personal.php?_c=<?=$_SESSION['RECID_CLIENTE']?>&_r=<?=$_SESSION['RECID_ROL']?>";
                dataType: "json",
                type: "GET",
                delay: opt2["delay"],
                data: function(params) {
