        ...
        <div class="col-12 col-sm-6">
            <div class="d-flex justify-content-sm-end justify-content-center mt-3 mt-sm-0">
                <div class="input-group w350">
                    ...
                    <input type="text" readonly class="form-control text-center border-0 radius ls2 h40" name="_dr" id="_dr">
                    <button title="Actualizar Grilla" type="button" id="Refresh" class="d-none btn fontq border-0 opa7 btn-custom" style=" border-top-left-radius: 0em 0em; border-bottom-left-radius: 0em 0em;">
                        <?=$icon_arrow_repeat?>
                    </button>
                </div>
            </div>
