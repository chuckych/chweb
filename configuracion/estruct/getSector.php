...
$query = "SELECT S.SecDesc AS 'descripcion', S.SecCodi AS 'codigo', (SELECT COUNT(1) FROM PERSONAL P WHERE P.LegSect=S.SecCodi AND P.LegNume > 0) AS 'cant' FROM SECTORES S";
