...
$query = "SELECT I.GruDesc AS 'descripcion', I.GruCodi AS 'codigo', (SELECT COUNT(1) FROM PERSONAL P WHERE P.LegGrup=I.GruCodi AND P.LegNume > 0) AS 'cant' FROM GRUPOS I";
...
if (sqlsrv_num_rows($rs) > 0) {
    while ($r = sqlsrv_fetch_array($rs)):
        ...
        $codigo = $r['codigo'];
        $descripcion = ($codigo == '0') ? 'Sin Grupo' : $r['descripcion'];
