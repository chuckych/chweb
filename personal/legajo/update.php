...
if (($_SERVER["REQUEST_METHOD"] == "POST") && ($_POST['Update_Leg'] == 'true')) {
    ...
    $LegSec2 = test_input($_POST['LegSec2']);
    $LegPlan = test_input($_POST['LegPlan']);
    $LegGrup = test_input($_POST['LegGrup']);
    $LegTDoc = test_input($_POST['LegTDoc']);
    $LegDocu = test_input($_POST['LegDocu']);
    $LegCUIT = test_input($_POST['LegCUIT']);
    $LegDomi = test_input($_POST['LegDomi']);
    $LegDoNu = test_input($_POST['LegDoNu']);
    $LegDoPi = test_input($_POST['LegDoPi']);
    $LegDoDP = test_input($_POST['LegDoDP']);
    $LegDoOb = test_input($_POST['LegDoOb']);
    $LegCOPO = test_input($_POST['LegCOPO']);
    $LegProv = test_input($_POST['LegProv']);
    $LegLoca = test_input($_POST['LegLoca']);
    $LegTel1 = test_input($_POST['LegTel1']);
    $LegTeO1 = test_input($_POST['LegTeO1']);
    $LegTel2 = test_input($_POST['LegTel2']);
    $LegTeO2 = test_input($_POST['LegTeO2']);
    $LegNaci = test_input($_POST['LegNaci']);
    $LegEsCi = test_input($_POST['LegEsCi']);
    $LegSexo = test_input($_POST['LegSexo']);
    $LegFeNa = test_input($_POST['LegFeNa']);
    $LegToTa = test_input($_POST['LegToTa']);
    $LegToSa = test_input($_POST['LegToSa']);
    $LegTipo = test_input($_POST['LegTipo']);
    $LegFeIn = test_input($_POST['LegFeIn']);
    $LegFeEg = test_input($_POST['LegFeEg']);
    $LegPrCo = test_input($_POST['LegPrCo']);
    $LegPrSe = test_input($_POST['LegPrSe']);
    $LegPrGr = test_input($_POST['LegPrGr']);
    $LegPrHo = test_input($_POST['LegPrHo']);
    $LegConv = test_input($_POST['LegConv']);
    $LegDesc = test_input($_POST['LegDesc']);
    $LegToIn = test_input($_POST['LegToIn']);
    $LegReTa = test_input($_POST['LegReTa']);
    $LegReIn = test_input($_POST['LegReIn']);
    $LegReSa = test_input($_POST['LegReSa']);
    $LegHLDe = test_input($_POST['LegHLDe']);
    $LegHLDH = test_input($_POST['LegHLDH']);
    $LegHLRo = test_input($_POST['LegHLRo']);
    $LegHGDe = test_input($_POST['LegHGDe']);
    $LegHGDH = test_input($_POST['LegHGDH']);
    $LegHGRo = test_input($_POST['LegHGRo']);
    $LegHSDe = test_input($_POST['LegHSDe']);
    $LegHSDH = test_input($_POST['LegHSDH']);
    $LegHSRo = test_input($_POST['LegHSRo']);
    $LegIncTi = test_input($_POST['LegIncTi']);
    $LegTel3 = test_input($_POST['LegTel3']);
    $LegMail = test_input($_POST['LegMail']);
    $LegHoAl = test_input($_POST['LegHoAl']);
    $LegHoLi = test_input($_POST['LegHoLi']);
    $LegEmpr = test_input($_POST['LegEmpr']);
    $LegGrHa = test_input($_POST['LegGrHa']);
    $LegArea = test_input($_POST['LegArea']);
    $LegAvisa = test_input($_POST['LegAvisa']);
    $LegChkHo = test_input($_POST['LegChkHo']);
    $LegAntes = test_input($_POST['LegAntes']);
    $LegDespu = test_input($_POST['LegDespu']);
    $LegTarde = test_input($_POST['LegTarde']);
    $LegRegCH = test_input($_POST['LegRegCH']);
    $LegPrRe = test_input($_POST['LegPrRe']);
    $LegPrPl = test_input($_POST['LegPrPl']);
    $LegValHora = test_input($_POST['LegValHora']);
    $LegTare = test_input($_POST['LegTare']);
    $LegHabSali = test_input($_POST['LegHabSali']);
    $LegNo24 = test_input($_POST['LegNo24']);
    $FechaHora = test_input($_POST['FechaHora']);
    $LegJornada = test_input($_POST['LegJornada']);
    $LegForPago = test_input($_POST['LegForPago']);
    $LegMoneda = test_input($_POST['LegMoneda']);
    $LegBanco = test_input($_POST['LegBanco']);
    $LegBanSuc = test_input($_POST['LegBanSuc']);
    $LegBanCTA = test_input($_POST['LegBanCTA']);
    $LegBanCBU = test_input($_POST['LegBanCBU']);
    $LegCalif = test_input($_POST['LegCalif']);
    $LegObs = test_input($_POST['LegObs']);
    $LegObsPlan = test_input($_POST['LegObsPlan']);
    $LegZona = test_input($_POST['LegZona']);
    $LegRedu = test_input($_POST['LegRedu']);
    $LegAFJP = test_input($_POST['LegAFJP']);
    $LegSind = test_input($_POST['LegSind']);
    $LegActi = test_input($_POST['LegActi']);
    $LegModa = test_input($_POST['LegModa']);
    $LegSitu = test_input($_POST['LegSitu']);
    $LegCond = test_input($_POST['LegCond']);
    $LegSine = test_input($_POST['LegSine']);
    $LegTicket = test_input($_POST['LegTicket']);
    $LegBasico = test_input($_POST['LegBasico']);
    $LegImporte1 = test_input($_POST['LegImporte1']);
    $LegImporte2 = test_input($_POST['LegImporte2']);
    $LegImporte3 = test_input($_POST['LegImporte3']);
    $LegImporte4 = test_input($_POST['LegImporte4']);
    $LegImporte5 = test_input($_POST['LegImporte5']);
    $LegImporte6 = test_input($_POST['LegImporte6']);
    $LegTopeAde = test_input($_POST['LegTopeAde']);
    $LegCapiLRT = test_input($_POST['LegCapiLRT']);
    $LegCalcGan = test_input($_POST['LegCalcGan']);
    $LegTZ = test_input($_POST['LegTZ']);
    $LegTZ1 = test_input($_POST['LegTZ1']);
    $LegTZ2 = test_input($_POST['LegTZ2']);
    $LegTZ3 = test_input($_POST['LegTZ3']);
    $LegBandHor = test_input($_POST['LegBandHor']);
    $LegSucu = test_input($_POST['LegSucu']);
    ...
    if (sqlsrv_execute($stmt)) {
        ...
        ($LegFeEg != '17530101') ? MSQuery("DELETE FROM IDENTIFICA WHERE IDLegajo = $LegNume") : '';
        ($LegFeEg != '17530101') ? MSQuery("DELETE FROM FICHAS WHERE FicLega = $LegNume AND FicFech >= '$LegFeEg'") : '';
        ($LegFeEg != '17530101') ? MSQuery("DELETE FROM FICHAS1 WHERE FicLega = $LegNume AND FicFech >= '$LegFeEg'") : '';
        ($LegFeEg != '17530101') ? MSQuery("DELETE FROM FICHAS2 WHERE FicLega = $LegNume AND FicFech >= '$LegFeEg'") : '';
        ($LegFeEg != '17530101') ? MSQuery("DELETE FROM FICHAS3 WHERE FicLega = $LegNume AND FicFech >= '$LegFeEg'") : '';
        ($LegFeEg != '17530101') ? MSQuery("DELETE FROM REGISTRO WHERE RegLega = $LegNume AND RegFeAs >= '$LegFeEg'") : '';
        ($LegFeEg != '17530101') ? MSQuery("DELETE FROM FICHAS00 WHERE FicLega = $LegNume AND FicFech >= '$LegFeEg'") : '';
        ($LegFeEg != '17530101') ? MSQuery("DELETE FROM FICHAS01 WHERE FicLega = $LegNume AND FicFech >= '$LegFeEg'") : '';
        ($LegFeEg != '17530101') ? MSQuery("DELETE FROM FICHAS03 WHERE FicLega = $LegNume AND FicFech >= '$LegFeEg'") : '';
