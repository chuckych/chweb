    ...
    <div class="row m-0 border border-top-0 overflow-auto vh-100" style="max-height: 450px;min-height: 450px;">
        <div class="col-12 py-3">
            <div class="form-inline">
                ...
                <input type="text" class="form-control w300" id="LegApNo" value="<?= $pers['LegApNo'] ?>" name="LegApNo">
            </div>
            ...
            <!-- Domicilio -->
            <p class="fontq mt-3 mb-2">Domicilio:</p>
            <div class="form-inline">
                <!-- Calle -->
                ...
                <!-- Observacion -->
                <input type="text" name="LegDoOb" class="mx-2 form-control w300" placeholder="Observaciones" id="LegDoOb" value="<?= $pers['LegDoOb'] ?>" maxlength="40">
            </div>
            <div class="form-inline mt-2">
                <!-- Provincia -->
            ...
            <!-- Fin Domicilio -->
            <!-- Telefonos -->
            <p class="fontq mt-3 mb-2">Teléfonos:</p>
            <div class="form-inline">
