    ...
    <div class="row m-0 border border-top-0 overflow-auto vh-100" style="max-height: 450px;min-height: 450px;">
        <div class="col-12 py-3">
            <div class="form-inline">
                ...
                <input type="text" class="form-control w400" id="LegApNo" value="<?= $pers['LegApNo'] ?>" name="LegApNo"
                    maxlength="40">
            </div>
            <div class="form-inline mt-3" id="lista_leg">
                ...
                <input type="hidden" class="ml-2 form-control data_leg" value="<?= $pers['LegNume'] ?>" id="LegNume"
                    name="LegNume">
                <input type="number" class="ml-2 form-control data_leg" value="<?= $pers['LegDocu'] ?>" id="LegDocu"
                    name="LegDocu">
                <!-- Cuil -->
                <label for="LegCUIT" class="mx-2">CUIL</label>
                <input type="text" class="form-control data_leg" placeholder="00-00000000-0"
                    value="<?= $pers['LegCUIT'] ?>" id="LegCUIT" name="LegCUIT">
                <!-- Nacionalidad -->
                <label for="LegNaci" class="mx-2">Nacionalidad</label>
                <select class="form-control selectjs_naciones data_leg" style="min-width:200px;"
                    value="<?= $pers['LegNaci'] ?>" id="LegNaci" name="LegNaci">
                </select>
                <!-- Button modal altaNacion-->
                <span data-toggle="modal" data-target="#altaNacion" class="pointer">
                    <button id="btn__Nacion" type="button" class="ml-1 btn btn-sm btn-light text-secondary"
                        data-toggle="tooltip" data-placement="right" title="CREAR">
                        +
                    </button>
                </span>
            ...
            <div class="form-inline mt-2">
                ...
                <input type="text" class="form-control text-center" value="<?= $persLegFeNa ?>" id="LegFeNa"
                    name="LegFeNa" onkeyup="javascript:calcularEdad();" placeholder="dd/mm/yyyy">
            ...
            <div class="">
                ...
                <div class="form-inline">
                    ...
                    <input type="number" name="LegDoNu" class="form-control w80" id="LegDoNu"
                        value="<?= $pers['LegDoNu'] ?>">
                    <!-- Piso -->
                    <label for="LegDoPi" class="mx-2">Piso</label>
                    <input type="number" name="LegDoPi" class="form-control w70" id="LegDoPi"
                        value="<?= $pers['LegDoPi'] ?>">
                    <!-- Depto -->
                    <label for="LegDoDP" class="mx-2">Depto</label>
                    <input type="text" name="LegDoDP" class="form-control w60" id="LegDoDP"
                        value="<?= $pers['LegDoDP'] ?>" maxlength="2">
                    <!-- Cp -->
                    <label for="LegCOPO" class="mx-2">CP</label>
                    <input type="text" name="LegCOPO" class="form-control w100" id="LegCOPO"
                        value="<?= $pers['LegCOPO'] ?>">
                </div>
                <div class="form-inline mt-2">
                    <!-- Provincia -->
                    <label for="LegProv" class="mr-2 w80">Provincia</label>
                    <select class="form-control selectjs_provincias" style="min-width:250px;" id="LegProv"
                        name="LegProv">
                    </select>
                    <!-- Button modal altaProvincia-->
                    <span data-toggle="modal" data-target="#altaProvincia" class="pointer">
                        <button type="button" class="ml-1 btn btn-sm btn-light" data-toggle="tooltip"
                            data-placement="right" title="CREAR">
                            +
                        </button>
                    </span>
                ...
                <div class="form-inline mt-2">
                    ...
                    <select class="form-control selectjs_localidad" style="min-width:250px;" id="LegLoca"
                        name="LegLoca">
                    </select>
                ...
                <div class="form-inline mt-2">
                    ...
                    <label class="">
                        ...
                        <input type="text" name="LegDoOb" class="form-control w300" placeholder="Observaciones"
                            id="LegDoOb" value="<?= $pers['LegDoOb'] ?>" maxlength="40">
                    </label>
                </div>
            </div>
            <!-- Fin Domicilio -->
            ...
            <div class="form-inline">
                ...
                <input type="tel" class="form-control" value="<?= $pers['LegTel1'] ?>" id="LegTel1" name="LegTel1"
                    maxlength="15">
                <input type="text" class="mx-2 form-control" placeholder="Observaciones" value="<?= $pers['LegTeO1'] ?>"
                    id="LegTeO1" name="LegTeO1" maxlength="20">
            </div>
            <div class="form-inline mt-2">
                <label for="LegTel2" class="mr-2 w80">Teléfono</label>
                <input type="tel" class="form-control" value="<?= $pers['LegTel2'] ?>" id="LegTel2" name="LegTel2"
                    maxlength="15">
                <input type="text" class="mx-2 form-control" placeholder="Observaciones" value="<?= $pers['LegTeO2'] ?>"
                    id="LegTeO2" name="LegTeO2" maxlength="20">
            </div>
            <!-- Fin Telefonos -->
        </div>
    </div>
