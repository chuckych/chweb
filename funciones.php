...
{
    return 20260423; // Version de la base de datos local
}
...
function setParamsOrSession($params, $session)
{
    if ($params) {
        return $params;
    }
...
{
    //Crea un array de fechas (excluyendo el fin y el inicio)
    $aryRange = [];
