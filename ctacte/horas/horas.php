    ...
    <div class="container shadow pb-2">
        ...
        <div class="row bg-white radius pt-3 mb-0 pb-0">
            <div class="col-12 col-sm-6">
                ...
                <div class="custom-control custom-switch custom-control-inline w250 ml-1">
                    ...
                    <label class="custom-control-label" for="Visualizar" style="padding-top: 3px;"><span id="VerPor" data-toggle="tooltip" data-placement="top" data-html="true" title="<b>Incluye valores en cero.</b>">Mostrar Todo</span></label>
        ...
        <?php if ($nove[0]['peri']) { ?>
            <div class="row radius py-2">
                ...
                ?>
                <div class="col-12 col-sm-6">
                    <a title="Cta Cte Novedades" href="../" class="btn btn-outline-custom border-0 btn-sm fontq">Novedades</a>
                </div>
                    ...
                    <table class="table table-hover text-wrap w-100" id="table-cte_hor">
                        <thead class="text-uppercase">
                            ...
                            <th class="text-center" title="">
                                <span data-toggle="tooltip" data-placement="top" data-html="true" title="<b>RESULTADO DE CTA CTE</b>">CTA CTE</span>
                            </th>
                            <th class="text-center">
                                <span data-toggle="tooltip" data-placement="top" data-html="true" title="<b>HORAS HECHAS</b>">HECHAS</span>
                            </th>
                            <th class="text-center">
                                <span data-toggle="tooltip" data-placement="top" data-html="true" title="<b>JORNADA REDUCIDA<br> RESTA EN CTA CTE</b>">JOR R. -</span>
                            </th>
                            <th class="text-center">
                                <span data-toggle="tooltip" data-placement="top" data-html="true" title="<b>JORNADA REDUCIDA<br> SUMA EN CTA CTE</b>">JOR R. +</span>
                            </th>
                            <th class="text-center">
                                <span data-toggle="tooltip" data-placement="top" data-html="true" title="<b>FRANCOS<br/>RESTA EN CTA CTE</b>">FRANCOS -</span>
                            </th>
                            <th class="text-center">
                                <span data-toggle="tooltip" data-placement="top" data-html="true" title="<b>FRANCOS<br/>SUMA EN CTA CTE</b>">FRANCOS +</span>
                            </th>
