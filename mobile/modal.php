        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="row">
                    ...
                    <div class="col mt-2 pl-2 text-left text-secondary font-weight-normal">
                        <div class="datos">
                        <!-- <p><label class="w70">Nombre: </label><span class="fontq text-uppercase text-wrap font-weight-bold picName"></span></p> -->
                        <p><label class="w70">ID: </label><span class="fontq text-dark text-wrap picUid"></span></p>
                        ...
                        <p><label class="w70">Modo: </label><span class="fontq text-dark text-wrap picModo"></span></p>
                        <p><label class="w70">Tipo: </label><span class="fontq text-dark text-wrap picTipo"></span></p>
                        <p><label class="w70">Certeza: </label><span class="fontq text-dark text-wrap picCerteza"></span></p>
                        <p><label class="w70">Zona: </label><span class="fontq text-dark text-wrap picZona"></span> <span id="btnCrearZona" class="d-none"><button class="ml-2 btn btn-outline-custom border-0 btn-sm fontq">Crear Zona</button></span></p>
                        </div>
                    </div>
                </div>
