...
function statusFlags($statusFlags, $pathFlags, $createdDate)
{
    ...
    createDir($pathLog);
    fileLog($text, $pathLog . '/flagsLog_3.log');
...
$pathFlags = 'flags3.php'; // ruta del archivo de Log de errores
...
$url   = "http://apimobileapp.chweb.ar:7600/attention/api/punch-event/" . $flags_lastDate;
// echo ($url);
// exit;
