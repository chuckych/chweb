...
if (($_SERVER["REQUEST_METHOD"] == "POST")) {
    ...
    $_nombre      = FusNuloPOST('_nombre', "InforNov"); /**  Nombre del archivo*/
...
// exit;
    ...
    && test_input($_POST['FicNovT']=='0')
        ...
        $_titulo = 'INFORME DE NOVEDADES (AUSENCIAS)';
    }elseif(
        ...
        && test_input($_POST['FicNovA']=='0')
            ...
            $_titulo = 'INFORME DE NOVEDADES (LLEGADAS TARDES)';
        }elseif(
            ...
            && test_input($_POST['FicNovA']=='0')
                ...
                $_titulo = 'INFORME DE NOVEDADES (INCUMPLIMIENTOS)';
            }elseif(
                ...
                && test_input($_POST['FicNovA']=='0')
                    ...
                    $_titulo = 'INFORME DE NOVEDADES (SALIDAS ANTICIPADAS)';
                };

    $_titulo = $_titulo =='' ? 'INFORME DE NOVEDADES': $_titulo;
    $_nombre = $_nombre =='' ? strtoupper($_titulo): $_nombre;
    $title = ($_nombre == 'InforNov') ? strtoupper($_titulo): $_nombre;

    $_path = $_SERVER['DOCUMENT_ROOT'].'/'.HOMEHOST.'/informes/'.$_carpeta.'/reporte/archivos/';
    $fecha = new DateTime();
    ...
    try {
        ...
        $mpdf->SetTitle($title);
        $mpdf->SetSubject('Informe de Novedades');
        ...
        file_put_contents("../../../logs/error/Error_PDF_InforNov_".date('Ymd').".log", $e->getMessage(), FILE_APPEND | LOCK_EX);
        exit();
    }
}