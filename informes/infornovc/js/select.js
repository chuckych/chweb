...
// $(document).ready(function () {
    ...
    $(".selectjs_empresa").select2({
        ...
        ajax: {
            url: "/" + $("#_homehost").val() + "/informes/infornovc/getSelect/getEmpFichas.php",
            dataType: "json",
            type: "POST",
            delay: opt2["delay"],
    ...
    $(".selectjs_plantas").select2({
        ...
        ajax: {
            url: "/" + $("#_homehost").val() + "/informes/infornovc/getSelect/getPlanFichas.php",
            dataType: "json",
            type: "POST",
            delay: opt2["delay"],
            data: function (params) {
    ...
    $(".selectjs_sectores").select2({
        ...
        ajax: {
            url: "/" + $("#_homehost").val() + "/informes/infornovc/getSelect/getSectFichas.php",
            dataType: "json",
            type: "POST",
            delay: opt2["delay"],
            data: function (params) {
    ...
    $(".select_seccion").select2({
        ...
        ajax: {
            url: "/" + $("#_homehost").val() + "/informes/infornovc/getSelect/getSec2Fichas.php",
            dataType: "json",
            type: "POST",
            delay: opt2["delay"],
            data: function (params) {
    ...
    $(".selectjs_grupos").select2({
        ...
        ajax: {
            url: "/" + $("#_homehost").val() + "/informes/infornovc/getSelect/getGrupFichas.php",
            dataType: "json",
            type: "POST",
            delay: opt2["delay"],
            data: function (params) {
    ...
    $(".selectjs_sucursal").select2({
        ...
        ajax: {
            url: "/" + $("#_homehost").val() + "/informes/infornovc/getSelect/getSucFichas.php",
            dataType: "json",
            type: "POST",
            delay: opt2["delay"],
            data: function (params) {
    ...
    $(".selectjs_personal").select2({
        ...
        ajax: {
            url: "/" + $("#_homehost").val() + "/informes/infornovc/getSelect/getLegajosFichas.php",
            dataType: "json",
            type: "POST",
            delay: opt2["delay"],
            data: function (params) {
    ...
    $(".selectjs_FicNove").select2({
        ...
        ajax: {
            url: "/" + $("#_homehost").val() + "/informes/infornovc/getSelect/getFicNove.php",
            dataType: "json",
            type: "POST",
            delay: opt2["delay"],
            data: function (params) {
    ...
    $(".selectjs_tipoper").select2({
        ...
        ajax: {
            url: "/" + $("#_homehost").val() + "/informes/infornovc/getSelect/getTipoPerFichas.php",
            dataType: "json",
            type: "POST",
            delay: opt2["delay"],
            data: function (params) {
    ...
    refreshSelected('.selectjs_sectores');
    ...
    refreshUnselected('.selectjs_sectores');
