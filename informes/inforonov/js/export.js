$(document).ready(function () {
    ...
    const NotifOffset = 10;
    const NotifOffsetX = 0;
    const NotifOffsetY = 0;
    const NotifZindex = 9999;
    const NotifMouseOver = 'pause'
    const NotifEnter = 'animate__animated animate__fadeInDown';
    const NotifExit = 'animate__animated animate__fadeOutUp';
    const NotifAlign = 'right';
    const btnPDF = 'Generar PDF'
            ...
            success: function (data) {
                if (data.status == "ok") {
                    ...
                    if (data.destino == "V") {
                        ...
                        window.open(host + '/' + homehost + '/informes/inforonov/reporte/archivos/' + data.archivo, '_blank');
                    } else {
