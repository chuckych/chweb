...
// $('#rowFiltros').on('shown.bs.collapse', function () {
    ...
    $(".selectjs_empresa").select2({
        ...
        ajax: {
            url: "/" + $("#_homehost").val() + "/informes/inforfic/getSelect/getEmpFichas.php",
            dataType: "json",
            type: "POST",
            delay: opt2["delay"],
    ...
    $(".selectjs_plantas").select2({
        ...
        ajax: {
            url: "/" + $("#_homehost").val() + "/informes/inforfic/getSelect/getPlanFichas.php",
            dataType: "json",
            type: "POST",
            delay: opt2["delay"],
            data: function (params) {
    ...
    $(".selectjs_sectores").select2({
        ...
        ajax: {
            url: "/" + $("#_homehost").val() + "/informes/inforfic/getSelect/getSectFichas.php",
            dataType: "json",
            type: "POST",
            delay: opt2["delay"],
            data: function (params) {
    ...
    $(".select_seccion").select2({
        ...
        ajax: {
            url: "/" + $("#_homehost").val() + "/informes/inforfic/getSelect/getSec2Fichas.php",
            dataType: "json",
            type: "POST",
            delay: opt2["delay"],
            data: function (params) {
    ...
    $(".selectjs_grupos").select2({
        ...
        ajax: {
            url: "/" + $("#_homehost").val() + "/informes/inforfic/getSelect/getGrupFichas.php",
            dataType: "json",
            type: "POST",
            delay: opt2["delay"],
            data: function (params) {
    ...
    $(".selectjs_sucursal").select2({
        ...
        ajax: {
            url: "/" + $("#_homehost").val() + "/informes/inforfic/getSelect/getSucFichas.php",
            dataType: "json",
            type: "POST",
            delay: opt2["delay"],
            data: function (params) {
    ...
    $(".selectjs_personal").select2({
        ...
        ajax: {
            url: "/" + $("#_homehost").val() + "/informes/inforfic/getSelect/getLegajosFichas.php",
            dataType: "json",
            type: "POST",
            delay: opt2["delay"],
            data: function (params) {
    ...
    $(".selectjs_tipoper").select2({
        ...
        ajax: {
            url: "/" + $("#_homehost").val() + "/informes/inforfic/getSelect/getTipoPerFichas.php",
            dataType: "json",
            type: "POST",
            delay: opt2["delay"],
            data: function (params) {
