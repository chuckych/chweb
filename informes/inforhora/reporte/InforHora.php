    ...
    foreach ($dataAgrup as $key => $valueAgrup) {
        ...
        <div style="page-break-inside: avoid">
                    ...
                    if ($_TotHoras == '1') { /** Mostramos el total de horas por columna */
                        ...
                        <tr>
                            ...
                            foreach ($dataTotHorLeg as $dataTotHorLeg) {
                                ...
                                <td class="px-2 vtop center bold ls1" style="font-size:11px;">
                                    <?= ceronull($dataTotHorLeg['HsHechas']) ?>
                                </td>
                                <td class="px-2 vtop center bold bg-light ls1" style="font-size:11px;">
                                    <?= ceronull($dataTotHorLeg['HsAutorizadas']) ?>
                                </td>
                                <?php
                            }
                            ?>
            ...
            if ($_TotNove == '1') { /** Mostramos el total resumen de Novedades por columna */
                ?>
                <div class="py-1"><b>Resumen de Novedades:</b> <span class="">(<?= $valueLegajo['Legajo'] ?>)
                        <?= $valueLegajo['Nombre'] ?></span></div>
                <table>
                    <!-- <tr>
