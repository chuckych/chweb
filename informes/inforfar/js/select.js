...
$(document).ready(function () {
    ...
    $('.select2clear').select2({
        ...
        $(".selectjs_empresa").select2({
            ...
            ajax: {
                url: "/" + $("#_homehost").val() + "/informes/inforfar/getSelect/getEmpFichas.php",
                dataType: "json",
                type: "POST",
                delay: opt2["delay"],
        ...
        $(".selectjs_plantas").select2({
            ...
            ajax: {
                url: "/" + $("#_homehost").val() + "/informes/inforfar/getSelect/getPlanFichas.php",
                dataType: "json",
                type: "POST",
                delay: opt2["delay"],
                data: function (params) {
        ...
        $(".selectjs_sectores").select2({
            ...
            ajax: {
                url: "/" + $("#_homehost").val() + "/informes/inforfar/getSelect/getSectFichas.php",
                dataType: "json",
                type: "POST",
                delay: opt2["delay"],
                data: function (params) {
        ...
        $(".select_seccion").select2({
            ...
            ajax: {
                url: "/" + $("#_homehost").val() + "/informes/inforfar/getSelect/getSec2Fichas.php",
                dataType: "json",
                type: "POST",
                delay: opt2["delay"],
                data: function (params) {
        ...
        $(".selectjs_grupos").select2({
            ...
            ajax: {
                url: "/" + $("#_homehost").val() + "/informes/inforfar/getSelect/getGrupFichas.php",
                dataType: "json",
                type: "POST",
                delay: opt2["delay"],
                data: function (params) {
        ...
        $(".selectjs_sucursal").select2({
            ...
            ajax: {
                url: "/" + $("#_homehost").val() + "/informes/inforfar/getSelect/getSucFichas.php",
                dataType: "json",
                type: "POST",
                delay: opt2["delay"],
                data: function (params) {
        ...
        $(".selectjs_personal").select2({
            ...
            ajax: {
                url: "/" + $("#_homehost").val() + "/informes/inforfar/getSelect/getLegajosFichas.php",
                dataType: "json",
                type: "POST",
                delay: opt2["delay"],
                data: function (params) {
        ...
        $(".selectjs_FicNove").select2({
            ...
            ajax: {
                url: "/" + $("#_homehost").val() + "/informes/inforfar/getSelect/getFicNove.php",
                dataType: "json",
                type: "POST",
                delay: opt2["delay"],
                data: function (params) {
        ...
        ajax: {
            url: "/" + $("#_homehost").val() + "/informes/inforfar/getSelect/getTipoPerFichas.php",
            dataType: "json",
            type: "POST",
            delay: opt2["delay"],
            data: function (params) {
