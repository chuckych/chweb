                ...
                <!-- <div class="row d-flex align-items-center mt-3">
                    <div class="col-12">
                        <div class="custom-control custom-switch custom-control-inline ml-1 w300">
                            <input type="checkbox" class="custom-control-input" id="LegEsta">
                            <label class="custom-control-label" for="LegEsta" style="padding-top: 3px;"><span class="text-dark">No Controla Horario</span></label>
                        </div>
                    </div>
                </div> -->
            </div>
