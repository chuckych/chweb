...
<body class="animate__animated animate__fadeIn">
    ...
    <script src="js/procesar.js?v=<?= version_file("/cierres__/js/procesar.js") ?>"></script>
    <script src="js/select.js?v=<?= version_file("/cierres__/js/select.js") ?>"></script>
    <script src="js/trash-select.js?v=<?= version_file("/cierres__/js/trash-select.js") ?>"></script>
