<!-- jquery.min.js -->
<script src="/<?= HOMEHOST ?>/js/jquery-3.5.1-min.js"></script>
<script src="/<?= HOMEHOST ?>/js/select2.min.js"></script>
<script src="/<?= HOMEHOST ?>/js/bootstrap5/bootstrap.bundle.min.js"></script>
<script src="/<?= HOMEHOST ?>/vendor/igorescobar/jquery-mask-plugin/dist/jquery.mask.min.js"></script>
<script src="/<?= HOMEHOST ?>/proy/js/bootstrap-notify.js?<?=microtime(true)?>"></script>
<script src="/<?= HOMEHOST ?>/proy/js/main.js?<?=vjs()?>"></script>
