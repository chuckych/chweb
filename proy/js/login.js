$(function () {
    ...
    $("#formUser").bind("submit", function (e) {
        ...
        if ($("#usuario").val() == "") {
            ...
            let textErr = `<div class="d-inline-flex align-items-center text-danger font-weight-bold"><span class="bi bi-person-fill me-2 font15"></span>Usuario Requerido<div>`;
            notify(textErr, 'danger', 0, 'right')
            return;
        }
        if ($("#clave").val() == "") {
            ...
            let textErr = `<div class="d-inline-flex align-items-center text-danger font-weight-bold"><span class="bi bi-key me-2 font15"></span>Contraseña Requerida<div>`;
            notify(textErr, 'danger', 0, 'right')
            return;
        }
        $.ajax({
