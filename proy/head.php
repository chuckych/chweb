...
<meta name="description" content="Control de proyectos HRProcess">
...
<link rel="stylesheet" href="/<?= HOMEHOST ?>/proy/css/style.css?v=<?=microtime(true)?>">
<link rel="stylesheet" href="/<?= HOMEHOST ?>/proy/css/date.css?v=<?=microtime(true)?>">
