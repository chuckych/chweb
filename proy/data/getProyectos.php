...
$query = "SELECT `ProyID`, `ProyNom`, `ProyDesc`, `ProyEmpr`, `EmpDesc`, `ProyPlant`, `ProyPlantPlano`, `proy_plantillas`.`PlantDesc`, `pl`.`PlantDesc` as 'PlantPlano',`ProyResp`, `nombre` AS 'RespDesc', `ProyEsta`, `EstTipo`, `EstDesc`, `EstColor`, `ProyObs`, `ProyIni`, `ProyFin`, 
...
LEFT JOIN `proy_plantillas` `pl` ON `proy_proyectos`.`ProyPlantPlano`= `pl`.`PlantID` 
LEFT JOIN `usuarios` ON `proy_proyectos`.`ProyResp`=`usuarios`.`id` INNER JOIN `proy_estados` ON `proy_proyectos`.`ProyEsta`=`proy_estados`.`EstID` WHERE `proy_proyectos`.`ProyID` > 0";
