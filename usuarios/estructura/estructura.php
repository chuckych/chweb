    ...
    <div class="container shadow">
        ...
        <div class="pb-3">
            ...
            <div class="row bg-white shadow-sm py-3">
                ...
                <div class="col-6">
                    <a href="/<?= HOMEHOST ?>/usuarios/roles/?_c=<?= $recid_clienteRol ?>"
                        class="btn fontq mt-1 float-right m-0 opa7 text-white <?= $bgcolor ?>">Volver a Roles</a>
                </div>
                <div class="col-12">
                ...
                <div class="row bg-transparent mt-2">
                    ...
                    <div class="col-12 py-3 bg-white">
                        <ul class="nav nav-pills" id="pills-tab" role="tablist">
                            <li class="nav-item">
                                <a class="active border fontq btn btn-sm w120 btn-outline-secondary"
                                    id="pills-addsectores-tab" data-toggle="pill" href="#pills-addsectores" role="tab"
                                    aria-controls="pills-addsectores"
                                    aria-selected="true"><small></i>DISPONIBLES</small></a>
                            </li>
                            <?php if (estructura_rol($GetRol, $_GET['_r'], $_GET['e'], $arrayjson2)) {
                                $cant_rol = (estructura_rol_count($GetRol, $_GET['_r'], $_GET['e'], $arrayjson2));
                                ?>
                                <li class="nav-item ml-1">
                                    <a class="border fontq btn btn-sm w120 btn-outline-success" id="pills-deletesectores-tab"
                                        data-toggle="pill" href="#pills-deletesectores" role="tab"
                                        aria-controls="pills-deletesectores" aria-selected="false"><small></i>ACTIVOS <span
                                                class="ls1 fw5">(<?= $cant_rol ?>)</span></small></a>
                                </li>
                            <?php }
                            ; ?>
                        </ul>
                    ...
                    <div class="col-12 pb-3 animate__animated animate__fadeIn">
                        <div class="tab-content" id="pills-tabContent">
                            <div class="tab-pane fade show active" id="pills-addsectores" role="tabpanel"
                                aria-labelledby="pills-addsectores-tab">
                                <?php require __DIR__ . "/" . $e_tabla_a ?>
                            </div>
                            <?php if (estructura_rol($GetRol, $_GET['_r'], $_GET['e'], $arrayjson2)) { ?>
                                <div class="tab-pane fade" id="pills-deletesectores" role="tabpanel"
                                    aria-labelledby="pills-deletesectores-tab">
