...
<body class="animate__animated animate__fadeIn">
            ...
            <div class="p-3">
                ...
                <form action="<?= $_SERVER['PHP_SELF'] ?>" method="POST" name="perfil" onsubmit="return validar_form()" class="<?=$ocultar?>">
                    ...
                    <div class="form-inline">
                        ...
                        <input type="text" class="d-none d-sm-block form-control w40 border-0 ml-2 h50 bg-white text-dark fw5" disabled name="escritos">
                        <input type="hidden" class="" name="recid" id="" placeholder="" value="<?= $_SESSION["RECID_USER"] ?>"></div>
    ...
    </div><?php require __DIR__ . "../../../js/jquery.php"; ?><script>
