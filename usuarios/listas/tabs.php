...
<!-- Fin Novedaes Tab -->
<!-- Otras Novedades Tab -->
<div class="tab-pane fade" id="o_novedades" role="tabpanel" aria-labelledby="o_novedades-tab">
    <div class="row">
        <div class="col-12 col-lg-6">
            <div class="table-responsive mt-2">
...
<!-- Fin Rotaciones Tab -->
<!-- Tipo Horas Tab -->
<div class="tab-pane fade" id="tipoHoras" role="tabpanel" aria-labelledby="tipoHoras-tab">
    <div class="row">
        <div class="col-12 col-lg-6">
            <div class="table-responsive mt-2">
