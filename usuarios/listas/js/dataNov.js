$(function () {
    ...
    tableNovedades.on('init.dt', function () {
        ...
        let buttonsCheck = `
            <div class="">
                <button class="btn btn-link btn-sm fontq" id="checkAllNov">Marcar Todo</button>
                <button class="ml-1 btn btn-link btn-sm fontq" id="nocheckAllNov">Desmarcar Todo</button>
            </div>
            `
        let buttonsSubmit = `
            <div class="">
