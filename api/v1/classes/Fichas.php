...
class Fichas
{
    ...
    public function __construct()
    {
        ...
        $this->NameLog = date('Ymd') . '_fichas.log';
    }
    ...
    public function dateMinMax()
    {
        ...
        try {
            ...
            $this->log->trace('Fichas::' . __FUNCTION__ . ': ', $this->NameLog, $e);
            throw new \Exception('Error al obtener fechas mínimas y máximas', 400);
        } catch (\Exception $e) {
            $this->log->trace('Fichas::' . __FUNCTION__ . ': ', $this->NameLog, $e);
            throw $e;
        }
    ...
    public function legajos()
    {
        ...
        try {
            ...
            $this->log->trace('Fichas::' . __FUNCTION__ . ': ', $this->NameLog, $e);
            throw new \Exception('Error al obtener legajos en fichas', 400);
        } catch (\Exception $e) {
            $this->log->trace('Fichas::' . __FUNCTION__ . ': ', $this->NameLog, $e);
            throw $e;
        }
