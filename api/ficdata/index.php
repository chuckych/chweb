...
$qFic = "SELECT FICHAS.FicLega, PERSONAL.LegApNo FROM FICHAS
...
$qFicCount = "SELECT count(DISTINCT FICHAS.FicLega) as 'count' FROM FICHAS INNER JOIN PERSONAL ON FICHAS.FicLega = PERSONAL.LegNume $joinFichas3 $joinFichas2 $joinFichas1 $joinFichas4 WHERE FICHAS.FicLega > 0 $wcFicFech";
...
$qFic .= " GROUP BY FICHAS.FicLega, PERSONAL.LegApNo ORDER BY FICHAS.FicLega";
