...
$(document).ready(function () {
    ...
    $('#Filtros').on('shown.bs.modal', function () {
        ...
        $(".selectjs_empresa").select2({
            ...
            ajax: {
                url: "/" + $("#_homehost").val() + "/fichadas/getSelect/getEmpFichas.php?_c=" + $("#_c").val() + "&_r=" + $("#_r").val(),
                dataType: "json",
                type: "POST",
                delay: opt2["delay"],
        ...
        $(".selectjs_plantas").select2({
            ...
            ajax: {
                url: "/" + $("#_homehost").val() + "/fichadas/getSelect/getPlanFichas.php?_c=" + $("#_c").val() + "&_r=" + $("#_r").val(),
                dataType: "json",
                type: "POST",
                delay: opt2["delay"],
                data: function (params) {
        ...
        $(".selectjs_sectores").select2({
            ...
            ajax: {
                url: "/" + $("#_homehost").val() + "/fichadas/getSelect/getSectFichas.php?_c=" + $("#_c").val() + "&_r=" + $("#_r").val(),
                dataType: "json",
                type: "POST",
                delay: opt2["delay"],
                data: function (params) {
        ...
        $(".select_seccion").select2({
            ...
            ajax: {
                url: "/" + $("#_homehost").val() + "/fichadas/getSelect/getSec2Fichas.php?_c=" + $("#_c").val() + "&_r=" + $("#_r").val(),
                dataType: "json",
                type: "POST",
                delay: opt2["delay"],
                data: function (params) {
        ...
        $(".selectjs_grupos").select2({
            ...
            ajax: {
                url: "/" + $("#_homehost").val() + "/fichadas/getSelect/getGrupFichas.php?_c=" + $("#_c").val() + "&_r=" + $("#_r").val(),
                dataType: "json",
                type: "POST",
                delay: opt2["delay"],
                data: function (params) {
        ...
        $(".selectjs_sucursal").select2({
            ...
            ajax: {
                url: "/" + $("#_homehost").val() + "/fichadas/getSelect/getSucFichas.php?_c=" + $("#_c").val() + "&_r=" + $("#_r").val(),
                dataType: "json",
                type: "POST",
                delay: opt2["delay"],
                data: function (params) {
        ...
        $(".selectjs_personal").select2({
            ...
            ajax: {
                url: "/" + $("#_homehost").val() + "/fichadas/getSelect/getLegajosFichas.php?_c=" + $("#_c").val() + "&_r=" + $("#_r").val(),
                dataType: "json",
                type: "POST",
                delay: opt2["delay"],
                data: function (params) {
        ...
        $(".selectjs_tipoper").select2({
            ...
            ajax: {
                url: "/" + $("#_homehost").val() + "/fichadas/getSelect/getTipoPerFichas.php?_c=" + $("#_c").val() + "&_r=" + $("#_r").val(),
                dataType: "json",
                type: "POST",
                delay: opt2["delay"],
                data: function (params) {
