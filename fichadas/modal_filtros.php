            ...
            <div class="modal-body">
                ...
                <div class="row d-flex align-items-center mt-3">
                    <div class="col-12">
                        ...
                        <div class="custom-control custom-switch custom-control-inline ml-1 w300">
                            ...
                            <label class="custom-control-label" for="FicFalta" style="padding-top: 3px;"><span data-titler="Muestra días con fichadas impares" class="text-dark">Fichadas Inconsistentes</span></label>
                ...
                <div class="row d-flex align-items-center">
                    <div class="col-12">
                        <!-- Solo Fichadas -->
                        <div class="custom-control custom-switch custom-control-inline ml-1 w300">
                            <input checked type="checkbox" class="custom-control-input" id="onlyReg" value="1">
                            <label class="custom-control-label" for="onlyReg" style="padding-top: 3px;"><span data-titler="Muestra solo días con fichadas" class="text-dark">Solo Fichadas</span></label>
                        </div>
                    </div>
                </div>
            </div>
