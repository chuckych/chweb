...
<body class="animate__animated animate__fadeIn">
    ...
    <div class="container shadow pb-2">
        ...
        <!-- Encabezado -->
        <?php encabezado_mod('bg-fich', 'white', 'fichadas.png', MODULOS['fichar'], '') ?>
        <!-- Fin Encabezado -->
            ...
            <div class="row bg-white mt-2 p-3 radius">
                <div class="border p-3">
                    <div class="col-12 m-0">
                        ...
                        <div class="form-inline mt-2">
                            ...
                            <input type="number" name="FichLegaIni" id="FichLegaIni"
                                class="form-control w150 text-center h40" value="1" max="999999999">
                            <label for="FichLegaFin" class="mx-1">Al:</label>
                            <input type="number" name="FichLegaFin" id="FichLegaFin"
                                class="form-control w150 text-center h40" value="999999999" max="999999999">
                        </div>
                    </div>
                    <div class="col-12 mt-2">
                        <div class="form-inline mt-2">
                            <label for="FichFechaIni" class="mr-2 w120">Fecha Desde:</label>
                            <input type="text" class="form-control w150 h40" id="FichFechaIniView"
                                value="<?= date('d-m-Y') ?>" inputmode="numeric" placeholder="dd-mm-yyyy">
                            <input type="hidden" name="FichFechaIni" id="FichFechaIni" value="<?= date('Y-m-d') ?>">
                            <label for="FichFechaFin" class="mx-1">Al:</label>
                            <input type="text" class="form-control w150 h40" id="FichFechaFinView"
                                value="<?= date('d-m-Y') ?>" inputmode="numeric" placeholder="dd-mm-yyyy">
                            <input type="hidden" name="FichFechaFin" id="FichFechaFin" value="<?= date('Y-m-d') ?>">
                        </div>
                    </div>
                ...
                <div class=" form-inline mt-2">
                    ...
                    <div class="col-12 mt-2 d-flex justify-content-end">
                        <div class="form-inline mt-2">
                            <button type="submit" class="btn bg-custom btn-sm text-white fontq w150 h40"
                                id="submit"></button>
                        </div>
                    </div>
