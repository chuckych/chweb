                ...
                <div class="border p-3">
                    ...
                    <div class="col-12 mt-2">
                        <div class="form-inline mt-2">
                            ...
                            <input type="date" class="form-control w150 h40" name="FichFechaIni" id="FichFechaIni"
                                value="<?= date('Y-m-d') ?>">
                            <label for="FichFechaFin" class="mx-1">Al:</label>
                            <input type="date" class="form-control w150 h40" name="FichFechaFin" id="FichFechaFin"
                                value="<?= date('Y-m-d') ?>">
                        </div>
                    </div>
