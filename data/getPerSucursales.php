...
$query="SELECT PERSONAL.LegSucu AS 'id', SUCURSALES.SucDesc AS 'text' FROM PERSONAL INNER JOIN SUCURSALES ON PERSONAL.LegSucu=SUCURSALES.SucCodi WHERE PERSONAL.LegNume >'0' AND PERSONAL.LegFeEg='17530101' AND CONCAT(PERSONAL.LegSucu,SUCURSALES.SucDesc) LIKE '%$q%' AND PERSONAL.LegSucu >'0' AND PERSONAL.LegFeEg='17530101' $FilterEstruct $filtros GROUP BY PERSONAL.LegSucu, SUCURSALES.SucDesc";
// print_r($query); exit;
